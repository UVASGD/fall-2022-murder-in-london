...
{
    public class CustomAudioLineProvider : CustomLineProviderBehaviour
    {
        ...
        public override CustomLocalizedLine GetLocalizedLine(Line line)
        {
            ...
            return new CustomAudioLocalizedLine()
            {
                TextID = line.ID,
                RawText = text,
    ...
    public class CustomAudioLocalizedLine : CustomLocalizedLine
    {
        /// <summary>
